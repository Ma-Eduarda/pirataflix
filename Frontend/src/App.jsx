...
import TelaDetalhesFilme from "../src/pages/TelaDetalhesFilme";
    ...
    <>
      <Routes>
        <Route path="/" element={<MainLayout user={user} setUser={setUser} />}>
          ...
          <Route path="tela-perfil" element={<TelaPerfil user={user} setUser={setUser} />} />
          <Route path="filme/:id" element={<TelaDetalhesFilme user={user} />} />
          <Route
            path="tela-adm"
